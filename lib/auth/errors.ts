...
export const AuthErrors = {
  ...
  emailNotVerified: () =>
    new AuthError("Please verify your email address first.", "email_not_verified", 403),
  twoFactorRequired: () =>
    new AuthError("Two-factor authentication is required.", "2fa_required", 403),
  ...
  invalidCurrentPassword: () =>
    new AuthError("Your current password is incorrect.", "invalid_password", 401),
  noPasswordSet: () =>
    new AuthError(
  ...
  emailUnverified: () =>
    new AuthError("Your email address is not verified.", "email_not_verified", 403),
} as const;
