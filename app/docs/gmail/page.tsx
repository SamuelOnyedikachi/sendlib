  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-6 text-secondary leading-relaxed">
        <p>
          Sendlib uses secure OAuth2 flows to connect to your Gmail account. We never see, store, or
        ...
        <div className="p-4 border border-indigo-100 bg-indigo-50/50 rounded-xl text-[#505f76] text-sm">
          <strong className="text-primary-sendlib">Daily Limits:</strong> Personal/product Gmail
          accounts send up to 200 emails/day on Free (500/day on Pro). Google Workspace accounts
          send up to 1,000 emails/day on Free (2,000/day on Pro).
        </div>
        ...
        <div className="p-4 border border-emerald-100 bg-emerald-50/50 rounded-xl text-emerald-900 text-sm space-y-1">
          ...
          <p className="text-emerald-800 leading-relaxed">
            You can send emails directly from custom domain addresses (e.g.{" "}
            <code className="bg-emerald-100/80 px-1 rounded text-xs">hello@yourcompany.com</code>).
            Simply link your Google Workspace account using standard Google OAuth. Google Workspace
            handles all the DNS, SPF, and DKIM authentication for you automatically, so no domain
            configuration is needed on Sendlib!
          </p>
        </div>
        ...
        <ol className="list-decimal pl-5 space-y-4 text-[#75777d]">
          <li>
            Navigate to your Sendlib dashboard{" "}
            <Link
